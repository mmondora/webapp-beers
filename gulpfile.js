...
gulp.task("tests", function () {
    var stream = gulp.src(["./tests/unit/**/*.js", "./tests/integration/**/*.js"])
        .pipe(mocha({
...
gulp.task("jscs", function () {
    ...
    */
    ...
    try {
        sh("jscs ../../app/ --reporter ../../node_modules/jscs-html-reporter/jscs-html-reporter.js", {
            cwd: "./builds/jscs/"
        });
    } catch (ignore) {
...
*/
gulp.task("gh-pages", ["tests", "jscs"], function() {
